...
public class DetailActivity extends AppCompatActivity {
    ...
    @BindView(R.id.image_sandwich)
    ImageView ingredientsIv;
    @BindView((R.id.also_known_tv))
    TextView alsoKnownTV;
    @BindView(R.id.also_known_tv_label)
    TextView alsoKnownTVLabel;
    @BindView(R.id.origin_tv)
    TextView placeOfOrigin;
    @BindView(R.id.origin_tv_label)
    ...
    private void populateUI(Sandwich sandwich) {
        ...
        if (!sandwich.getIngredients().isEmpty()
                && sandwich.getIngredients() != null) {

            ListIterator<String> i = sandwich.getIngredients().listIterator();
            while (i.hasNext()) {
                ingredientsBuilder.append(i.next());
                if (i.hasNext())
